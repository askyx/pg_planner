...
#
# HEADERS List of header files to include in the extension.
#
...
function(add_postgresql_extension NAME)
  ...
  set(_multi SOURCES SCRIPTS SCRIPT_TEMPLATES REQUIRES HEADERS TEST_SOURCE)
  ...
  # extension.
  add_library(${NAME} MODULE ${_ext_SOURCES} ${_ext_TEST_SOURCE})
